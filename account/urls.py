...
from .views import check_phone_or_send_otp, verify, refresh_jwt_token, get_user_profile, update_user_profile, \
    delete_user_profile, register_user, login
...
urlpatterns = [
    ...
    path('check-phone/', check_phone_or_send_otp),
]
